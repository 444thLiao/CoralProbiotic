...
#nr_fna = '/mnt/maple/thliao/data/protein_db/NCBI/nr_20210713//nr'
# indir = '/mnt/ivy/thliao/project/coral_ruegeria/nanopore_processing/annotations/pseudofinder/*/'
# prokka_indir = "/mnt/ivy/thliao/project/coral_ruegeria/nanopore_processing/canu_o/*/09_prokka/"
# # indir = '/mnt/ivy/thliao/project/coral_ruegeria/data_processing/pub_dataset/pseudogenes'
# # prokka_indir = '/mnt/ivy/thliao/project/coral_ruegeria/data_processing/pub_dataset/pseudogenes/prokka_o/*/'
# odir = indir if '*' not in indir else indir.rsplit('/',2)[0]
# existsed_subnr = f'/mnt/ivy/thliao/project/coral_ruegeria/nanopore_processing/annotations/pseudofinder/subnr'
#################################
...
if __name__ == '__main__':
    cli()
    # cd /mnt/ivy/thliao/project/coral_ruegeria/nanopore_processing/annotations/pseudofinder &&  python /mnt/ivy/thliao/project/coral_ruegeria/merged_pseudogenes_bin.py -i './*/*_nr_pseudos.gff,/mnt/ivy/thliao/project/coral_ruegeria/data_processing/pub_dataset/pseudogenes/*/*_nr_pseudos.gff' -o ./ step1 && python /mnt/ivy/thliao/project/coral_ruegeria/merged_pseudogenes_bin.py -i './*/*_nr_pseudos.gff,/mnt/ivy/thliao/project/coral_ruegeria/data_processing/pub_dataset/pseudogenes/*/*_nr_pseudos.gff' -o ./ step2 -gp '/mnt/ivy/thliao/project/coral_ruegeria/nanopore_processing/canu_o/*/09_prokka/*.gbk,/mnt/ivy/thliao/project/coral_ruegeria/data_processing/pub_dataset/prokka_o/*/*.gbk'  && python /mnt/ivy/thliao/project/coral_ruegeria/merged_pseudogenes_bin.py -i './*/*_nr_pseudos.gff,/mnt/ivy/thliao/project/coral_ruegeria/data_processing/pub_dataset/pseudogenes/*/*_nr_pseudos.gff' -o ./ step3 &&   python /mnt/ivy/thliao/project/coral_ruegeria/merged_pseudogenes_bin.py -i './*/*_nr_pseudos.gff,/mnt/ivy/thliao/project/coral_ruegeria/data_processing/pub_dataset/pseudogenes/*/*_nr_pseudos.gff' -o ./ merge
